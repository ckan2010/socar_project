...
var admin = (function(){
	...
	return{
				...
				if (data.totCount===0) {
					...
					$.each(data.list, function(i,notice){
						notice_list +=
							'<tr>'
							+'<td>'+notice.seq+'</td>'
							+'<td class="subj"><a href="#" onclick="admin.admin_notice_content('+notice.seq+')" id="a_admin_notice_content">'+notice.title+'</a></td>'
		...
		admin_notice_content : function(seq){
			$('#admin_article').empty();
			var frame = '';
			var notice_content = '';
